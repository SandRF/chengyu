...
var SoundManager = (function () {
    ...
    SoundManager.prototype.startLoad = function () {
        ...
        this.bgm.addEventListener(egret.Event.COMPLETE, function () {
            _this.isbgmComplete = true;
        }, this);
        this.ef_right = new egret.Sound();
        this.ef_right.load("resource/assets/data/sound/right.mp3");
        this.ef_right.addEventListener(egret.Event.COMPLETE, function () {
            _this.isef_rightComplete = true;
        }, this);
        this.ef_wrong = new egret.Sound();
        this.ef_wrong.load("resource/assets/data/sound/wrong.mp3");
        this.ef_wrong.addEventListener(egret.Event.COMPLETE, function () {
            _this.isef_wrongComplete = true;
        }, this);
        this.ef_btnclick = new egret.Sound();
        this.ef_btnclick.load("resource/assets/data/sound/buttonclick.mp3");
        this.ef_btnclick.addEventListener(egret.Event.COMPLETE, function () {
            _this.isef_btnclickComplete = true;
        }, this);
        this.ef_word = new egret.Sound();
        this.ef_word.load("resource/assets/data/sound/type_word.mp3");
        this.ef_word.addEventListener(egret.Event.COMPLETE, function () {
            _this.isef_wordComplete = true;
        }, this);
    };
    /**开启bgm */
